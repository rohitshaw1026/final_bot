...
def talk(semester):
    ...
    if semester=="sem 1" or semester=="sem1":
        semester="sem 1"
        paper_choice = input("Choose the Paper: micro macro matheco indianeco ecotrix general ").lower()
    else:
        semester = "sem 2"
        paper_choice = input("Choose the Paper: micro macro history deveco ecotrix ").lower()

    # Iterate through each paper in the chosen semester to find the right one
    ...
    print("ChatBot: Wrong Choice!!!")

# Main function
def chat():
    print(greet())
    print(f"I am {get_bot_name()}.")
    print("I am going to share my master's personal honest opinions. So don't ignore!!!")
